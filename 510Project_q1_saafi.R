...
par(mar=c(2,2,2,2))
par(mfrow=c(2,2))
plot(mpgTrain$cylinders , mpgTrain$mpg, xlab='Cylinders' ,ylab='MPG', main="MPG vs Cylinders")
abline(lm(mpgTrain$mpg ~ mpgTrain$cylinders), col="red")
...
lm.mpg.cylinder <- lm(mpg ~ cylinders, data = mpgTrain)
summary(lm.mpg.cylinder)
plot(lm.mpg.cylinder)
...
res.cyl=residuals(lm.mpg.cylinder)
...
par(mar=c(3,3,3,3))
par(mfrow=c(2,2))
plot(mpgTrain$cylinders, res.cyl, xlab = "Cylinders", ylab = "Residuals: Cylinders", main = "Residuals vs Cylinders")
...
ab.res.cyl=abs(residuals(lm.mpg.cylinder))
...
par(mar=c(3,3,3,3))
par(mfrow=c(2,2))
plot(mpgTrain$cylinders, ab.res.cyl , xlab = "Cylinders", ylab = "Residuals: Cylinders", main = "Residuals vs Cylinders")
